...
``LockReason`` names the three conditions that keep the starter inhibited
after pre-drive; all three resolve through the same operator override
request (``APIClient.request_override``).
